...
class FileSelectorApi {
  ...
  Future<List<String?>> startFileExplorer(FileSelectorMethod arg_method, SelectionOptions arg_options, String? arg_initialDirectory, String? arg_confirmButtonText) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.FileSelectorApi.startFileExplorer', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_method.index, arg_options, arg_initialDirectory, arg_confirmButtonText]) as Map<Object?, Object?>?;
    if (replyMap == null) {
  ...
  Future<String?> openSaveDialog(SelectionOptions arg_options, String? arg_initialDirectory, String? arg_confirmButtonText, String? arg_suggestedName) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.FileSelectorApi.openSaveDialog', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_options, arg_initialDirectory, arg_confirmButtonText, arg_suggestedName]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
