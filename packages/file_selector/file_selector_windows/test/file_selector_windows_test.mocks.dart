...
class MockDartFileSelectorAPI extends _i1.Mock
  ...
  List<String> getFiles(
      ...
      (super.noSuchMethod(
          ...
          returnValue: <String>[]) as List<String>);
  @override
  int getOptions(_i5.Pointer<_i5.Uint32>? ptrOptions, int? hResult,
          _i6.IFileOpenDialog? dialog) =>
      (super.noSuchMethod(
          Invocation.method(#getOptions, [ptrOptions, hResult, dialog]),
  ...
  int setDialogOptions(
      ...
      (super.noSuchMethod(
          Invocation.method(#setDialogOptions,
              [ptrOptions, hResult, selectionOptions, dialog]),
          returnValue: 0) as int);
  @override
  ...
  int initializeComLibrary() =>
      (super.noSuchMethod(Invocation.method(#initializeComLibrary, []),
          returnValue: 0) as int);
  @override
  List<String> returnSelectedElements(int? hResult,
