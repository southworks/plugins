...
class MockDartFileSelectorAPI extends _i1.Mock
  ...
  List<String> getFiles(
      ...
      (super.noSuchMethod(
          ...
          returnValue: <String>[]) as List<String>);
  @override
  int getOptions(int? hResult, _i5.Pointer<_i5.Uint32>? ptrOptions,
          _i6.IFileOpenDialog? dialog) =>
      (super.noSuchMethod(
          Invocation.method(#getOptions, [hResult, ptrOptions, dialog]),
  ...
  int setDialogOptions(
          ...
          _i6.IFileOpenDialog? dialog) =>
      (super.noSuchMethod(
          Invocation.method(#setDialogOptions,
              [hResult, ptrOptions, selectionOptions, dialog]),
          returnValue: 0) as int);
  @override
  ...
  int addConfirmButtonLabel(
      ...
      (super.noSuchMethod(
          ...
          returnValue: 0) as int);
  @override
  int addFileFilters(int? hResult, _i3.SelectionOptions? selectionOptions,
          _i6.IFileOpenDialog? fileDialog) =>
      (super.noSuchMethod(
          Invocation.method(
              #addFileFilters, [hResult, selectionOptions, fileDialog]),
          returnValue: 0) as int);
  @override
  int setSuggestedFileName(int? hResult, String? suggestedFileName,
          _i6.IFileOpenDialog? fileDialog) =>
      (super.noSuchMethod(
          Invocation.method(
              #setSuggestedFileName, [hResult, suggestedFileName, fileDialog]),
          returnValue: 0) as int);
  @override
